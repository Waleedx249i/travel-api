...
class AdminTourTest extends TestCase
{
    ...
    public function test_public_user_cannot_access_adding_tour(): void
    {
        ...
        $response = $this->postJson('http://127.0.0.1:8000/api/v1/admin/travels/'.$travel->id.'/tours');
    ...
    public function test_non_admin_user_cannot_access_adding_tour(): void
    {
        ...
        $travel = Travel::factory()->create();
        $response = $this->actingAs($user)->postJson('http://127.0.0.1:8000/api/v1/admin/travels/'.$travel->id.'/tours');
