...
class AdminTravelTest extends TestCase
{
    ...
    {
        $response = $this->postJson('http://127.0.0.1:8000/api/v1/admin/travels');
    ...
    public function test_non_admin_user_cannot_access_adding_travel(): void
    {
        ...
        $response = $this->actingAs($user)->postJson('http://127.0.0.1:8000/api/v1/admin/travels');
    ...
    public function test_update_travel_successfully_with_valid_data(): void
    {
        ...
        $response = $this->actingAs($user)->putJson('http://127.0.0.1:8000/api/v1/admin/travels/'.$travel->id, [
            'name' => 'Travel name',
        ]);
        $response->assertStatus(422);
